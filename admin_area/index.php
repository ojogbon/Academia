	...
	<div class="sin-w3-agile">
		...
		<form  method="post">
			<div class="username">
				...
				<input type="email" name="itusername" class="name" placeholder="Email eg: example@gmail.com" required="">
				<div class="clearfix"></div>
			</div>
			<div class="password-agileits">
				<span class="username">Password:</span>
				<input type="password" name="itpassword" class="password" placeholder="eg iowe9239ewsdi" required="">
				<div class="clearfix"></div>
			</div>
			...
			<div class="login-w3">
					<input type="submit" name="pleasejustdothelogin" class="login" value="Sign In">
			</div>
			<div class="clearfix"></div>
			<?php 
