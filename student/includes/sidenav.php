						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
								<ul id="menu" >
                                    ...
                                    <li id="menu-academico" ><a href="completeProfile.php"><i class="fa fa-user-plus nav_icon"></i><span>Request Tutor</span><div class="clearfix"></div></a></li>
                                    <li id="menu-academico" ><a href="#"><i class="fa fa-plus nav_icon"></i><span>Chat room</span><div class="clearfix"></div></a></li>
