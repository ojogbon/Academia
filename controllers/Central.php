<?php
    ...
    include ($_SERVER['DOCUMENT_ROOT']."/". $parent_path.'models/Tutor.php');
    include ($_SERVER['DOCUMENT_ROOT']."/". $parent_path.'models/Student.php');
    ...
    if(count($_SESSION) > 1){
        ...
        if(isset($_SESSION["staff_Online_fullName"])){
            ...
            $staff_Online_image = $_SESSION["staff_Online_image"] ;
        }

        else if(isset($_SESSION["tutor_Online_fullName"])){
            $tutor_Online_fullName =  $_SESSION["tutor_Online_fullName"];
            $tutor_Online_id =  $_SESSION["tutor_Online_id"] ;
            // $staff_Online_image = $_SESSION["staff_Online_image"] ;
        }

        else if(isset($_SESSION["student_Online_fullName"])){
            $student_Online_fullName =  $_SESSION["student_Online_fullName"];
            $student_Online_id =  $_SESSION["student_Online_id"] ;
            // $staff_Online_image = $_SESSION["staff_Online_image"] ;
        }
